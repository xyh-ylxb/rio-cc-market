...
<manual_override> Use /core:compound [context] to document immediately without waiting for auto-detection. </manual_override> </auto_invoke>
...
- **Manual trigger**: User can invoke agents after /core:compound completes for deeper review

## Related Commands

- `/research [topic]` - Deep investigation (searches docs/solutions/ for patterns)
- `/core:plan` - Planning workflow (references documented solutions)