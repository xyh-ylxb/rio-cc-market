...
This command takes an existing plan (from `/core.plan`) and enhances each section with parallel research agents. Each major element gets its own dedicated research sub-agent to find:
...
<thinking>
Check for documented learnings from /core.compound. These are solved problems stored as markdown files. Spawn a sub-agent for each learning to check if it's relevant.
</thinking>

**LEARNINGS LOCATION - Check these exact folders:**

```
docs/solutions/           <-- PRIMARY: Project-level learnings (created by /core.compound)
├── performance-issues/
│   └── *.md
├── debugging-patterns/
│   └── *.md
...
2. **Learnings/Solutions sub-agents** - Relevant documented learnings from /core.compound
...
3. **Start `/core.work`** - Begin implementing this enhanced plan
